tubemap = {
  ...
  "Baker Street": [
    "Marylebone", "Regent's Park", "Edgware Road (C)", "Great Portland Street",
    "Bond Street"
  ],
  "Bank":
  ["Liverpool Street", "St. Paul's", "London Bridge", "Moorgate", "Waterloo"],
  ...
  "Green Park": [
    "Westminster", "Hyde Park Corner", "Picadilly Circus", "Oxford Circus",
    "Victoria", "Bond Street"
  ],
  "High Street Kensington": ["Gloucester Road"],
  "Holborn":
  ["Tottenham Court Road", "Russell Square", "Chancery Lane", "Covent Garden"],
  "Hyde Park Corner": ["Knightsbridge", "Green Park"],
  "King's Cross St. Pancras":
  ["Russell Square", "Euston Square", "Farringdon", "Angel", "Euston"],
  ...
  "Picadilly Circus":
  ["Charing Cross", "Oxford Circus", "Green Park", "Leicester Square"],
  "Pimlico": ["Victoria"],
  ...
  ["Holborn", "Oxford Circus", "Goodge Street", "Leicester Square"],
  ...
  "Waterloo":
  ["Westminster", "Embankment", "Lambeth North", "Southwark", "Bank"],
